...
int main() {
    ...
    equazione_2 eq;
    cout << "Inserire i coefficienti a, b e c di una equazione di secondo grado" << endl;
    cout << "Coefficiente a: ";
    cin >> eq.a;
    cout << "Coefficiente b: ";
    cin >> eq.b;
    ...
    // Caso degenere
    if (eq.a == 0) {
        cout << "Attenzione: si tratta di una equazione degenere!" << endl;
        double x = 0.0;
        equazione_1 e1;
        e1.a = eq.b;
        e1.b = eq.c;
        ...
        switch (r) {
            case 1:
                ...
                break;
            case 0:
                cout << "L'equazione e' verificata per qualunque x" << endl;
                break;
            case -1:
                cout << "Non esiste x che verifichi l'equazione" << endl;
                break;
        }
    }
    // Caso non degenere
        ...
        switch (r) {
            case 1:
                ...
                break;
            case 0:
                cout << "L'equazione ha due soluzioni reali e coincidenti" << endl;
